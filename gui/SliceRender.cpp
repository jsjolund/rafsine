...
// //Constructor
// SliceRender::SliceRender(osg::GraphicsContext *gc, cudaStream_t renderStream, unsigned int width, unsigned int height)
//     : renderStream(renderStream), width_(width), height_(height),
//       plot_d_(width * height)
// {
//   // ext_ = osg::GLExtensions::Get(gc->getState()->getContextID(), true);
//   // ext_ = gc->getState()->get<osg::GLExtensions>();
//   std::cout << ext_->glVersion << std::endl;
//   // Create a pixel buffer object and its corresponding texture for rendering
//   // generate a buffer ID
//   ext_->glGenBuffers(1, &pboID_);
//   // make this the current UNPACK buffer (openGL is state-based)
//   ext_->glBindBuffer(GL_PIXEL_UNPACK_BUFFER, pboID_);
//   // allocate data for the buffer (3 channels: red, greeen, blue)
//   ext_->glBufferData(GL_PIXEL_UNPACK_BUFFER, 3 * width_ * height_ * sizeof(GLubyte),
...
//   color_scheme_ = ColorScheme::OBLIVION;
// }
...
//     compute_color_kernel_black_and_white<<<grid_size, block_size, 0, renderStream>>>(color_array_d, gpu_ptr(), width_, height_, min, max);
//     break;
//   case ColorScheme::RAINBOW:
//     compute_color_kernel_rainbow<<<grid_size, block_size, 0, renderStream>>>(color_array_d, gpu_ptr(), width_, height_, min, max);
//     break;
//   case ColorScheme::DIVERGING:
//     compute_color_kernel_diverging<<<grid_size, block_size, 0, renderStream>>>(color_array_d, gpu_ptr(), width_, height_, min, max);
//     break;
//   case ColorScheme::OBLIVION:
//     compute_color_kernel_Oblivion<<<grid_size, block_size, 0, renderStream>>>(color_array_d, gpu_ptr(), width_, height_, min, max);
//     break;
//   case ColorScheme::BLUES:
//     compute_color_kernel_blues<<<grid_size, block_size, 0, renderStream>>>(color_array_d, gpu_ptr(), width_, height_, min, max);
//     break;
//   case ColorScheme::SAND:
//     compute_color_kernel_sand<<<grid_size, block_size, 0, renderStream>>>(color_array_d, gpu_ptr(), width_, height_, min, max);
//     break;
//   case ColorScheme::FIRE:
//     compute_color_kernel_fire<<<grid_size, block_size, 0, renderStream>>>(color_array_d, gpu_ptr(), width_, height_, min, max);
//     break;
//   case ColorScheme::PARAVIEW:
//     compute_color_kernel_paraview<<<grid_size, block_size, 0, renderStream>>>(color_array_d, gpu_ptr(), width_, height_, min, max);
//     break;
//   }
