 ...
 public:
  ...
  DistributedDFGroup(unsigned int Q, unsigned int latticeSizeX,
      ...
      : Topology(latticeSizeX, latticeSizeY, latticeSizeZ, subdivisions),
        m_Q(Q),
        m_dfCPU(Q * latticeSizeX * latticeSizeY * latticeSizeZ),
  ...
  inline DistributedDFGroup &operator=(
      const DistributedDFGroup &f) {
  ...
  static inline void swap(DistributedDFGroup &f1,
                          DistributedDFGroup &f2) {
