...
__device__ __forceinline__ void computeMRT(int x,
  ...
  omega2 = -0.077777777777777793f * m10diff -
           ...
           3.5284750217750149e-17f * m17diff - 1.8214721265120573e-17f * m18diff -
           0.0054678362573099444f * m1diff - 0.02222222222222223f * m2diff +
           0.12f * m4diff + 3.0870522256950994e-19f * m6diff +
           3.8290411073743348e-18f * m8diff +
           0.05555555555555558f * m9diff * tau_V;
  ...
  omega5 =
      0.038888888888888896f * m10diff - 0.08333333333333337f * m11diff * tau_V +
      0.11666666666666663f * m12diff - 1.4164799996519842e-17f * m15diff * tau_V -
  ...
  omega6 = 0.038888888888888883f * m10diff -
           ...
           0.11999999999999998f * m8diff - 0.027777777777777755f * m9diff * tau_V;
  omega7 =
      0.019444444444444431f * m10diff + 0.083333333333333315f * m11diff * tau_V +
      0.058333333333333313f * m12diff + 0.25f * m13diff * tau_V +
      0.2475f * m16diff - 0.2475f * m17diff + 0.0039766081871345027f * m1diff +
      0.0055555555555555558f * m2diff + 0.029999999999999975f * m4diff +
      0.030000000000000006f * m6diff + 8.5632953907980939e-18f * m8diff +
      0.027777777777777762f * m9diff * tau_V;
  omega8 =
      0.019444444444444455f * m10diff + 0.083333333333333315f * m11diff * tau_V +
      0.058333333333333313f * m12diff + 0.25f * m13diff * tau_V -
      0.2475f * m16diff + 0.2475f * m17diff + 0.0039766081871345045f * m1diff +
      0.0055555555555555575f * m2diff - 0.029999999999999995f * m4diff -
      0.030000000000000009f * m6diff + 5.3716100862084035e-18f * m8diff +
      0.027777777777777797f * m9diff * tau_V;
  omega9 =
      0.019444444444444448f * m10diff + 0.083333333333333315f * m11diff * tau_V +
      0.058333333333333313f * m12diff - 0.25f * m13diff * tau_V +
      0.2475f * m16diff + 0.2475f * m17diff + 0.0039766081871345019f * m1diff +
      0.005555555555555554f * m2diff + 0.029999999999999985f * m4diff -
      0.029999999999999988f * m6diff + 0.027777777777777783f * m9diff * tau_V;
  omega10 =
      0.019444444444444448f * m10diff + 0.083333333333333329f * m11diff * tau_V +
      0.058333333333333327f * m12diff - 0.25f * m13diff * tau_V -
      0.2475f * m16diff - 0.2475f * m17diff + 0.0039766081871345027f * m1diff +
      0.0055555555555555558f * m2diff - 0.029999999999999992f * m4diff +
      0.029999999999999995f * m6diff + 1.0032289829428092e-17f * m8diff +
  ...
  omega12 =
      ...
      0.2475f * m16diff - 0.2475f * m18diff + 0.0039766081871345027f * m1diff +
      0.0055555555555555558f * m2diff - 0.030000000000000009f * m4diff -
      0.029999999999999999f * m8diff + 0.027777777777777776f * m9diff * tau_V;
  omega13 =
      0.019444444444444434f * m10diff - 0.083333333333333329f * m11diff * tau_V -
      0.058333333333333327f * m12diff - 0.25f * m15diff * tau_V -
      0.2475f * m16diff - 0.2475f * m18diff + 0.0039766081871345027f * m1diff +
      0.0055555555555555558f * m2diff + 0.029999999999999988f * m4diff -
      0.029999999999999999f * m8diff + 0.027777777777777766f * m9diff * tau_V;
  omega14 =
      0.019444444444444448f * m10diff - 0.083333333333333356f * m11diff * tau_V -
      0.058333333333333348f * m12diff - 0.25f * m15diff * tau_V +
      0.2475f * m16diff + 0.2475f * m18diff + 0.0039766081871345036f * m1diff +
      0.0055555555555555558f * m2diff - 0.030000000000000009f * m4diff +
      0.030000000000000009f * m8diff + 0.027777777777777787f * m9diff * tau_V;
