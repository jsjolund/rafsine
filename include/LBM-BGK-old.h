...
// dftmp3D(0, x, y, z, nx, ny, nz) = (1.0 - 1.0 / tau) * f0 + (1.0 / tau) *
// f0eq; dftmp3D(1, x, y, z, nx, ny, nz) = (1.0 - 1.0 / tau) * f1 + (1.0 / tau)
// * f1eq; dftmp3D(2, x, y, z, nx, ny, nz) = (1.0 - 1.0 / tau) * f2 + (1.0 /
// tau) * f2eq; dftmp3D(3, x, y, z, nx, ny, nz) = (1.0 - 1.0 / tau) * f3 + (1.0
// / tau) * f3eq; dftmp3D(4, x, y, z, nx, ny, nz) = (1.0 - 1.0 / tau) * f4 +
// (1.0 / tau) * f4eq; dftmp3D(5, x, y, z, nx, ny, nz) = (1.0 - 1.0 / tau) * f5
// + (1.0 / tau) * f5eq +
//                                   0.5 * gBetta * (T - Tref);
// dftmp3D(6, x, y, z, nx, ny, nz) = (1.0 - 1.0 / tau) * f6 + (1.0 / tau) * f6eq
// -
//                                   0.5 * gBetta * (T - Tref);
// dftmp3D(7, x, y, z, nx, ny, nz) = (1.0 - 1.0 / tau) * f7 + (1.0 / tau) *
// f7eq; dftmp3D(8, x, y, z, nx, ny, nz) = (1.0 - 1.0 / tau) * f8 + (1.0 / tau)
// * f8eq; dftmp3D(9, x, y, z, nx, ny, nz) = (1.0 - 1.0 / tau) * f9 + (1.0 /
// tau) * f9eq; dftmp3D(10, x, y, z, nx, ny, nz) = (1.0 - 1.0 / tau) * f10 +
//                                    (1.0 / tau) * f10eq;
