...
TEST(Lattice, Three) {
  ...
  ASSERT_EQ(lattice.getPartitionContaining(0, 0, 513), p0);
  ASSERT_EQ(lattice.getPartitionContaining(0, 0, 514), p1);
  ASSERT_EQ(lattice.getPartitionContaining(0, 0, 515), p1);
  ASSERT_EQ(lattice.getPartitionContaining(0, 0, 1028), p2);
  ASSERT_EQ(lattice.getPartitionContaining(0, 0, 1029), p2);
  ASSERT_EQ(lattice.getPartitionContaining(0, 0, 1542), p3);
