...
m1_1 =
    12.666666666666666 * jx + 12.666666666666666 * jy + 12.666666666666666 * jz;
m1_9 = -1.3333333333333333 * jx + 0.66666666666666663 * jy +
       0.66666666666666663 * jz;
...
Fup = 0.055555555555555552 * gBetta * rho * (1 - vz) * (T - Tref) *
...
omega1 = -0.077777777777777765 * m10neq - 0.0054678362573099409 * m1neq -
         ...
         0.1111111111111111 * m9neq / (6.0 * nu + 6.0 * nu_t + 1.0);
omega2 = -0.077777777777777765 * m10neq - 0.0054678362573099409 * m1neq -
         0.02222222222222222 * m2neq + 0.12 * m4neq +
         0.1111111111111111 * m9neq / (6.0 * nu + 6.0 * nu_t + 1.0);
omega3 = 0.038888888888888883 * m10neq +
         0.16666666666666666 * m11neq / (6.0 * nu + 6.0 * nu_t + 1.0) -
         0.11666666666666665 * m12neq - 0.0054678362573099409 * m1neq -
         0.02222222222222222 * m2neq - 0.12 * m6neq -
         0.055555555555555552 * m9neq / (6.0 * nu + 6.0 * nu_t + 1.0);
omega4 = 0.038888888888888883 * m10neq +
         0.16666666666666666 * m11neq / (6.0 * nu + 6.0 * nu_t + 1.0) -
         0.11666666666666665 * m12neq - 0.0054678362573099409 * m1neq -
         0.02222222222222222 * m2neq + 0.12 * m6neq -
         0.055555555555555552 * m9neq / (6.0 * nu + 6.0 * nu_t + 1.0);
omega5 = 0.038888888888888883 * m10neq -
         0.16666666666666666 * m11neq / (6.0 * nu + 6.0 * nu_t + 1.0) +
         0.11666666666666665 * m12neq - 0.0054678362573099409 * m1neq -
         0.02222222222222222 * m2neq - 0.12 * m8neq -
         0.055555555555555552 * m9neq / (6.0 * nu + 6.0 * nu_t + 1.0);
omega6 = 0.038888888888888883 * m10neq -
         ...
         0.02222222222222222 * m2neq + 0.12 * m8neq -
         0.055555555555555552 * m9neq / (6.0 * nu + 6.0 * nu_t + 1.0);
omega7 = 0.019444444444444441 * m10neq +
         0.16666666666666666 * m11neq / (6.0 * nu + 6.0 * nu_t + 1.0) +
         ...
         0.029999999999999999 * m6neq +
         0.055555555555555552 * m9neq / (6.0 * nu + 6.0 * nu_t + 1.0);
omega8 = 0.019444444444444441 * m10neq +
         0.16666666666666666 * m11neq / (6.0 * nu + 6.0 * nu_t + 1.0) +
         0.058333333333333327 * m12neq +
         0.5 * m13neq / (6.0 * nu + 6.0 * nu_t + 1.0) - 0.2475 * m16neq +
         0.2475 * m17neq + 0.0039766081871345027 * m1neq +
         ...
         0.029999999999999999 * m6neq +
         0.055555555555555552 * m9neq / (6.0 * nu + 6.0 * nu_t + 1.0);
omega9 = 0.019444444444444441 * m10neq +
         0.16666666666666666 * m11neq / (6.0 * nu + 6.0 * nu_t + 1.0) +
         0.058333333333333327 * m12neq -
         0.5 * m13neq / (6.0 * nu + 6.0 * nu_t + 1.0) + 0.2475 * m16neq +
         0.2475 * m17neq + 0.0039766081871345027 * m1neq +
         ...
         0.029999999999999999 * m6neq +
         0.055555555555555552 * m9neq / (6.0 * nu + 6.0 * nu_t + 1.0);
omega10 = 0.019444444444444441 * m10neq +
          0.16666666666666666 * m11neq / (6.0 * nu + 6.0 * nu_t + 1.0) +
          0.058333333333333327 * m12neq -
          0.5 * m13neq / (6.0 * nu + 6.0 * nu_t + 1.0) - 0.2475 * m16neq -
          0.2475 * m17neq + 0.0039766081871345027 * m1neq +
...
omega12 = 0.019444444444444441 * m10neq -
          ...
          0.029999999999999999 * m8neq +
          0.055555555555555552 * m9neq / (6.0 * nu + 6.0 * nu_t + 1.0);
omega13 = 0.019444444444444441 * m10neq -
          0.16666666666666666 * m11neq / (6.0 * nu + 6.0 * nu_t + 1.0) -
          0.058333333333333327 * m12neq -
          0.5 * m15neq / (6.0 * nu + 6.0 * nu_t + 1.0) - 0.2475 * m16neq -
          0.2475 * m18neq + 0.0039766081871345027 * m1neq +
          ...
          0.029999999999999999 * m8neq +
          0.055555555555555552 * m9neq / (6.0 * nu + 6.0 * nu_t + 1.0);
omega14 = 0.019444444444444441 * m10neq -
          0.16666666666666666 * m11neq / (6.0 * nu + 6.0 * nu_t + 1.0) -
          0.058333333333333327 * m12neq -
          0.5 * m15neq / (6.0 * nu + 6.0 * nu_t + 1.0) + 0.2475 * m16neq +
          0.2475 * m18neq + 0.0039766081871345027 * m1neq +
...
// Relax temperature
omegaT0 = 0.14285714285714285 * n0neq + 0.14285714285714285 * n4neq;
omegaT1 = 0.14285714285714285 * n0neq +
          0.5 * n1neq * (4.0 * nuT + 0.5 + 4.0 * nu_t / Pr_t) -
          0.023809523809523808 * n4neq + 0.16666666666666666 * n5neq;
omegaT2 = 0.14285714285714285 * n0neq -
          0.5 * n1neq * (4.0 * nuT + 0.5 + 4.0 * nu_t / Pr_t) -
          0.023809523809523808 * n4neq + 0.16666666666666666 * n5neq;
omegaT3 = 0.14285714285714285 * n0neq +
          0.5 * n2neq * (4.0 * nuT + 0.5 + 4.0 * nu_t / Pr_t) -
          0.023809523809523808 * n4neq - 0.083333333333333329 * n5neq +
          0.25 * n6neq;
omegaT4 = 0.14285714285714285 * n0neq -
          0.5 * n2neq * (4.0 * nuT + 0.5 + 4.0 * nu_t / Pr_t) -
          0.023809523809523808 * n4neq - 0.083333333333333329 * n5neq +
          0.25 * n6neq;
omegaT5 = 0.14285714285714285 * n0neq +
          0.5 * n3neq * (4.0 * nuT + 0.5 + 4.0 * nu_t / Pr_t) -
          0.023809523809523808 * n4neq - 0.083333333333333329 * n5neq -
          0.25 * n6neq;
omegaT6 = 0.14285714285714285 * n0neq -
          0.5 * n3neq * (4.0 * nuT + 0.5 + 4.0 * nu_t / Pr_t) -
          0.023809523809523808 * n4neq - 0.083333333333333329 * n5neq -
          0.25 * n6neq;
