...
f1eq =
    0.055555555555555552 * rho * (sq_term + 4.5 * pow(vx, 2) + 3.0 * vx + 1.0);
f2eq =
    0.055555555555555552 * rho * (sq_term + 4.5 * pow(vx, 2) - 3.0 * vx + 1.0);
f3eq =
    0.055555555555555552 * rho * (sq_term + 4.5 * pow(vy, 2) + 3.0 * vy + 1.0);
f4eq =
    0.055555555555555552 * rho * (sq_term + 4.5 * pow(vy, 2) - 3.0 * vy + 1.0);
f5eq =
    0.055555555555555552 * rho * (sq_term + 4.5 * pow(vz, 2) + 3.0 * vz + 1.0);
f6eq =
    0.055555555555555552 * rho * (sq_term + 4.5 * pow(vz, 2) - 3.0 * vz + 1.0);
...
S_bar = sqrt(pow(Sxx, 2) + 2.0 * pow(Sxy, 2) + 2.0 * pow(Sxz, 2) + pow(Syy, 2) +
             2.0 * pow(Syz, 2) + pow(Szz, 2));
...
dftmp3D(5, x, y, z, nx, ny, nz) = Fup + f5 - 1.0 * f5 / tau_V +
                                  1.0 * f5eq / tau_V;
dftmp3D(6, x, y, z, nx, ny, nz) = Fdown + f6 - 1.0 * f6 / tau_V +
                                  1.0 * f6eq / tau_V;
...
dftmp3D(10, x, y, z, nx, ny, nz) = f10 - 1.0 * f10 / tau_V +
                                   1.0 * f10eq / tau_V;
dftmp3D(11, x, y, z, nx, ny, nz) = f11 - 1.0 * f11 / tau_V +
                                   1.0 * f11eq / tau_V;
dftmp3D(12, x, y, z, nx, ny, nz) = f12 - 1.0 * f12 / tau_V +
                                   1.0 * f12eq / tau_V;
dftmp3D(13, x, y, z, nx, ny, nz) = f13 - 1.0 * f13 / tau_V +
                                   1.0 * f13eq / tau_V;
dftmp3D(14, x, y, z, nx, ny, nz) = f14 - 1.0 * f14 / tau_V +
                                   1.0 * f14eq / tau_V;
dftmp3D(15, x, y, z, nx, ny, nz) = f15 - 1.0 * f15 / tau_V +
                                   1.0 * f15eq / tau_V;
dftmp3D(16, x, y, z, nx, ny, nz) = f16 - 1.0 * f16 / tau_V +
                                   1.0 * f16eq / tau_V;
dftmp3D(17, x, y, z, nx, ny, nz) = f17 - 1.0 * f17 / tau_V +
                                   1.0 * f17eq / tau_V;
dftmp3D(18, x, y, z, nx, ny, nz) = f18 - 1.0 * f18 / tau_V +
                                   1.0 * f18eq / tau_V;
