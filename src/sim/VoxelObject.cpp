...
VoxelBox::VoxelBox(std::string name, glm::ivec3 voxMin, glm::ivec3 voxMax,
                   glm::vec3 min, glm::vec3 max, real temperature)
    : VoxelVolume(name, voxMin, voxMax, min, max), m_temperature(temperature) {
  VoxelType::Enum type = VoxelType::Enum::WALL;
  glm::vec3 velocity(NaN, NaN, NaN);
  ...
  glm::ivec3 origin, dir1, dir2, normal;
  VoxelQuad quad;
  NodeMode::Enum mode;

  origin = glm::ivec3(voxMin);
  dir1 = glm::ivec3(0, voxMax.y - voxMin.y, 0);
  dir2 = glm::ivec3(0, 0, voxMax.z - voxMin.z);
  ...
  origin = glm::ivec3(voxMax.x, voxMin.y, voxMin.z);
  dir1 = glm::ivec3(0, voxMax.y - voxMin.y, 0);
  dir2 = glm::ivec3(0, 0, voxMax.z - voxMin.z);
  normal = glm::ivec3(1, 0, 0);
  mode = NodeMode::Enum::INTERSECT;
  ...
  origin = glm::ivec3(voxMin);
  dir1 = glm::ivec3(voxMax.x - voxMin.x, 0, 0);
  dir2 = glm::ivec3(0, 0, voxMax.z - voxMin.z);
  ...
  origin = glm::ivec3(voxMin.x, voxMax.y, voxMin.z);
  dir1 = glm::ivec3(voxMax.x - voxMin.x, 0, 0);
  dir2 = glm::ivec3(0, 0, voxMax.z - voxMin.z);
  normal = glm::ivec3(0, 1, 0);
  mode = NodeMode::Enum::INTERSECT;
  ...
  origin = glm::ivec3(voxMin);
  dir1 = glm::ivec3(voxMax.x - voxMin.x, 0, 0);
  dir2 = glm::ivec3(0, voxMax.y - voxMin.y, 0);
  ...
  origin = glm::ivec3(voxMin.x, voxMin.y, voxMax.z);
  dir1 = glm::ivec3(voxMax.x - voxMin.x, 0, 0);
  dir2 = glm::ivec3(0, voxMax.y - voxMin.y, 0);
  normal = glm::ivec3(0, 0, 1);
  mode = NodeMode::Enum::INTERSECT;
